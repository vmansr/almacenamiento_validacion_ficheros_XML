...
6. Se incorporo inicio-rapido.ps1 en la raiz como comando unico de arranque para uso diario y revision docente.
7. Se incorporo verificacion de Docker y espera activa de disponibilidad de eXist-db en scripts/inicio-rapido.ps1 para evitar fallos de conexion temprana.

## Ejecucion del programa (operacion diaria)
### Inicio recomendado
